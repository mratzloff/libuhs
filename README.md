...
Formatting tokens are used to mark up text with more fine-grained control than the earlier coarse-grained `text` element formatting. These provide support for Windows-1252 character encoding, hyperlinks, a monospace typeface, and word wrap controls.
