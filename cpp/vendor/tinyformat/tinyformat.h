...
#define TINYFORMAT_VARARGS_14                                                           \
	const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, \
	    const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11,       \
	    const T12 &v12, const T13 &v13, const T14 &v14
#define TINYFORMAT_VARARGS_15                                                           \
	const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, \
	    const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11,       \
	    const T12 &v12, const T13 &v13, const T14 &v14, const T15 &v15
#define TINYFORMAT_VARARGS_16                                                           \
	const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, \
	    const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11,       \
	    const T12 &v12, const T13 &v13, const T14 &v14, const T15 &v15, const T16 &v16
...
public:
	...
	void format(
	    std::ostream& out, const char* fmtBegin, const char* fmtEnd, int ntrunc) const {
...
inline const char* streamStateFromFormat(std::ostream& out, bool& positionalMode,
    bool& spacePadPositive, int& ntrunc, const char* fmtStart,
    const detail::FormatArg* args, int& argIndex, int numArgs) {
	...
	if (!widthSet) {
		...
		int width = 0;
		widthSet =
		    parseWidthOrPrecision(width, c, positionalMode, args, argIndex, numArgs);
		if (widthSet) {
			if (width < 0) {
...
inline void formatImpl(
    std::ostream& out, const char* fmt, const detail::FormatArg* args, int numArgs) {
	// Saved stream state
	...
	while (true) {
		...
		int ntrunc = -1;
		const char* fmtEnd = streamStateFromFormat(
		    out, positionalMode, spacePadPositive, ntrunc, fmt, args, argIndex, numArgs);
...
#undef TINYFORMAT_MAKE_FORMATLIST_CONSTRUCTOR
	...
	FormatListN(const FormatListN& other) : FormatList(&m_formatterStore[0], N) {
		std::copy(
		    &other.m_formatterStore[0], &other.m_formatterStore[N], &m_formatterStore[0]);
	}
